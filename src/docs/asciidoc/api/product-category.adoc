...
include::{snippets}/product-category-all/http-request.adoc[]

==== HTTP Response

include::{snippets}/product-category-all/http-response.adoc[]
include::{snippets}/product-category-all/response-fields-data.adoc[]
